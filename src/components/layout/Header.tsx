...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setIsSticky(scrollTop > 100); // Header becomes sticky after 100px scroll
    };
  ...
  return (
    <header className={`top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm transition-all duration-300 ${
