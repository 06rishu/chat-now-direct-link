...
const WaMe91 = () => {
  ...
  const countryOptions = [
    { code: "93", name: "Afghanistan (+93)", countryCode: "AF" },
    { code: "355", name: "Albania (+355)", countryCode: "AL" },
    { code: "213", name: "Algeria (+213)", countryCode: "DZ" },
    { code: "1684", name: "American Samoa (+1684)", countryCode: "AS" },
    ...
    { code: "5997", name: "Bonaire (+59997)", countryCode: "BQ" },
    ...
    { code: "242", name: "Congo (Republic of) (+242)", countryCode: "CG" },
    { code: "243", name: "Congo (Democratic Republic of) (+243)", countryCode: "CD" },
    { code: "682", name: "Cook Islands (+682)", countryCode: "CK" },
    { code: "506", name: "Costa Rica (+506)", countryCode: "CR" },
    { code: "225", name: "Côte d'Ivoire (+225)", countryCode: "CI" },
    { code: "385", name: "Croatia (+385)", countryCode: "HR" },
    { code: "53", name: "Cuba (+53)", countryCode: "CU" },
    { code: "5999", name: "Curaçao (+5999)", countryCode: "CW" },
    { code: "357", name: "Cyprus (+357)", countryCode: "CY" },
    ...
    { code: "44", name: "Guernsey (+44)", countryCode: "GG" },
    ...
    { code: "383", name: "Kosovo (+383)", countryCode: "XK" },
    ...
    { code: "230", name: "Mauritius (+230)", countryCode: "MU" },
    ...
    { code: "382", name: "Montenegro (+382)", countryCode: "ME" },
    ...
    { code: "95", name: "Myanmar (+95)", countryCode: "MM" },
    ...
    { code: "850", name: "North Korea (+850)", countryCode: "KP" },
    { code: "670", name: "Northern Mariana Islands (+670)", countryCode: "MP" },
    { code: "47", name: "Norway (+47)", countryCode: "NO" },
    { code: "968", name: "Oman (+968)", countryCode: "OM" },
    { code: "92", name: "Pakistan (+92)", countryCode: "PK" },
    { code: "680", name: "Palau (+680)", countryCode: "PW" },
    { code: "970", name: "Palestine (+970)", countryCode: "PS" },
    ...
    { code: "290", name: "Saint Helena (+290)", countryCode: "SH" },
    { code: "1869", name: "Saint Kitts & Nevis (+1869)", countryCode: "KN" },
    { code: "1758", name: "Saint Lucia (+1758)", countryCode: "LC" },
    { code: "508", name: "Saint Pierre and Miquelon (+508)", countryCode: "PM" },
    { code: "685", name: "Samoa (+685)", countryCode: "WS" },
    { code: "1784", name: "Saint Vincent and the Grenadines (+1784)", countryCode: "VC" },
    ...
    { code: "381", name: "Serbia (+381)", countryCode: "RS" },
    ...
    { code: "1782", name: "Sint Maarten (+1782)", countryCode: "SX" },
    { code: "421", name: "Slovakia (+421)", countryCode: "SK" },
    ...
    { code: "82", name: "South Korea (+82)", countryCode: "KR" },
    { code: "211", name: "South Sudan (+211)", countryCode: "SS" },
    ...
    { code: "963", name: "Syria (+963)", countryCode: "SY" },
    { code: "886", name: "Taiwan (+886)", countryCode: "TW" },
    { code: "7", name: "Tajikstan (+7)", countryCode: "TJ" },
    { code: "255", name: "Tanzania (+255)", countryCode: "TZ" },
    { code: "66", name: "Thailand (+66)", countryCode: "TH" },
    { code: "670", name: "Timor-Leste (+670)", countryCode: "TL" },
    ...
    { code: "967", name: "Yemen (+967)", countryCode: "YE" },
