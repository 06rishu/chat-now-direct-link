...
const Agent5 = () => {
  // Now using data from agent 6 (index 5)
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 to-green-100">
      ...
      <section className="container mx-auto px-4 mb-8">
        <VideoCallCard
          ...
          videoCallLink="#"
          nextLink="/live-support/agent-6"
          variant="default"
          stats={agent.stats}
          nextButtonHandler={() => navigate("/live-support/agent-6")}
          prevButtonHandler={() => navigate("/live-support/agent-4")}
        />
      </section>
