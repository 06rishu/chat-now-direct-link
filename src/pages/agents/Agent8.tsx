...
const Agent8 = () => {
  // Now using data from agent 9 (index 8)
  const agent = agents[8];
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 to-green-100">
      ...
      <section className="container mx-auto px-4 mb-8">
        <VideoCallCard
          ...
          videoCallLink="#"
          nextLink="/live-support/agent-9"
          variant="default"
          stats={agent.stats}
          nextButtonHandler={() => navigate("/live-support/agent-9")}
          prevButtonHandler={() => navigate("/live-support/agent-7")}
        />
      </section>
