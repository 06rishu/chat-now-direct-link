...
const Agent7 = () => {
  // Now using data from agent 8 (index 7)
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 to-green-100">
      ...
      <section className="container mx-auto px-4 mb-8">
        <VideoCallCard
          ...
          videoCallLink="#"
          nextLink="/live-support/agent-8"
          variant="default"
          stats={agent.stats}
          nextButtonHandler={() => navigate("/live-support/agent-8")}
          prevButtonHandler={() => navigate("/live-support/agent-6")}
        />
      </section>
