      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden font-sans transition-all duration-300 hover:shadow-xl">
        ...
        <div className="p-6">
          <div className="text-center animate-fade-in">
            ...
            <button
              onClick={handleNext}
              className="w-full gradient-bg text-white font-bold py-3 px-6 rounded-xl shadow-lg transform transition-all duration-300 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 flex items-center justify-center pulse"
            >
